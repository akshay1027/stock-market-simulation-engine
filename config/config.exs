...
config :stock_market_simulation_engine,
  ecto_repos: [StockMarketSimulationEngine.Repo]
...
config :stock_market_simulation_engine, StockMarketSimulationEngine.Mailer, adapter: Swoosh.Adapters.Local
